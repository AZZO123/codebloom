// ignore_for_file: camel_case_types, await_only_futures, avoid_print

import 'dart:convert';

import 'package:flutter/material.dart';
import 'package:palnt_app/Model/Model.dart';
...
class alarmprovider extends ChangeNotifier {
  ...
  SecduleNotification(
      String namealarm, DateTime datetim, int Randomnumber) async {
    int newtime =
